...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EddystoneScanner/EddystoneScanner.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Folly/folly.framework"
  install_framework "${PODS_ROOT}/NearBee/NearBee/NearBee.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RNNearBee/RNNearBee.framework"
